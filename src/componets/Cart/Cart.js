...
const Cart = () => {
    const { cart, totalQuantity, totalPrecio, clearCart } = useContext(CartContext);


    if (totalQuantity() === 0) {
        return (
            <div className='container'>
                <h1 className='containerH1'> No hay Productos </h1>
        ...
        <div className='Container2'>
            ...
            <div className='container-total'>
                ...
                <div className='ButtonD'>
                    ...
                    <button className='ca' onClick={() => clearCart()}> Limpiar carrito </button>
